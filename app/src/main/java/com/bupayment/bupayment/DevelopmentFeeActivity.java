...
public class DevelopmentFeeActivity extends AppCompatActivity {
    EditText roll,reg,name,mname,fname,semester,dept,fac,mainFee,misceFee,totalFee;
    Button developmentFeePayBtn;
    ...
    String URL="http://192.168.56.1:9095/DevelopmentFees/restApiDevelopmentFeeController";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_development_fee);
        ...
        developmentFeePayBtn = findViewById(R.id.developmentFeePayBtn);
        ...
        developmentFeePayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if(validity_status == true){

                    Toast.makeText(DevelopmentFeeActivity.this,"TRUE",Toast.LENGTH_SHORT).show();
