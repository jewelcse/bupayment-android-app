...
import custom_function.Student_profile;
import cz.msebera.android.httpclient.Header;

public class AdmissionFeeActivity extends AppCompatActivity {


    EditText roll,reg,name,mname,fname,semester,dept,fac,mainFee,misceFee,totalFee;
    Button admissionFeePayBtn;
    ...
    String URL="http://192.168.56.1:9095/DevelopmentFees/restApiAdmissionFeeController";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admission_fee);
        ...
        admissionFeePayBtn = findViewById(R.id.admissionFeePayBtn);
        ...
        admissionFeePayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if(validity_status == true){

                    Toast.makeText(AdmissionFeeActivity.this,"TRUE",Toast.LENGTH_SHORT).show();
